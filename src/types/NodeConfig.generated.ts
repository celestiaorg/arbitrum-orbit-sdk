...
//
// IMAGE: ghcr.io/celestiaorg/nitro:v2.3.3
// TIMESTAMP: 2024-06-06T21:32:42.266Z
//
// ---
...
export type NodeConfig = {
  ...
  'execution'?: {
    ...
    'tx-pre-checker'?: {
      /** how long ago should the storage conditions from eth_SendRawTransactiVersion: development, time: development */
  ...
  'node'?: {
    ...
    'celestia-cfg'?: {
      ...
      /** Enable Celestia DA */
      'enable'?: boolean;
      /** Gas multiplier for Celestia transactions (default 1.01) */
      'gas-multiplier'?: number;
      /** Gas for retrying Celestia transactions (default 0.01) */
      'gas-price'?: number;
      /** Celestia Namespace to post data to */
      'namespace-id'?: string;
      /** Noop writer (disable posting to celestia) */
      'noop-writer'?: boolean;
      /** Rpc endpoint for celestia-node */
      'rpc'?: string;
      'validator-config'?: {
        /** Blobstream address, only used for validation */
        'blobstream'?: string;
        /** L1 Websocket connection, only used for validation */
        'eth-rpc'?: string;
        /** Tendermint RPC endpoint, only used for validation */
