...
//
// IMAGE: dfcelestia/nitro-node-dev:latest
// TIMESTAMP: 2024-04-02T17:24:24.661Z
//
// ---
...
export type NodeConfig = {
  ...
  'node'?: {
    ...
    'celestia-cfg'?: {
      ...
      'auth-token'?: string;
      /** Address for BlobstreamX contract */
      'blobstreamx-address'?: string;
      /** Enable Celestia DA */
      'enable'?: boolean;
      /** Eth Client RPC endpoint, only used when the node is a batch poster */
      'eth-rpc'?: string;
      /** Size of event channel for BlobstreamX DataCommitmentStored */
      'event-channel-size'?: number;
      /** Gas for Celestia transactions (default 0.1) */
      'gas-price'?: number;
      /** Node is batch poster node */
      'is-poster'?: boolean;
      /** Celestia Namespace to post data to */
      'namespace-id'?: string;
      /** Rpc endpoint for celestia-node */
      'rpc'?: string;
      /** Tendermint RPC endpoint, only used when the node is a batch poster */
